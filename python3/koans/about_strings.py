...
class AboutStrings(Koan):
    ...
    def test_double_quoted_strings_are_also_strings(self):
        string = "Hello, world."
        self.assertTrue(__, isinstance(string, str))
...
"""
    ...
    def test_plus_will_not_modify_original_strings(self):
        ...
        there = "world"
        string = hi + there
        self.assertTrue(__, hi)
        self.assertTrue(__, there)
